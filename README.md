...
## ⭐ New Features 
- 2024/06/04:  Support remote viewer with viser and SIBR viwer.
...
**SIBR Viewer**. You can follow [here](https://github.com/RongLiu-Leo/Gaussian-Splatting-Monitor) to download the [pre-built viewer](https://drive.google.com/file/d/1DRFrtFUfz27QvQKOWbYXbRS2o2eSgaUT/view) for Windows. 
